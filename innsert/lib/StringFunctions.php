...
class StringFunctions
{
     ...
     * @return	string
     */
    public static function randomAlpha($long = 10, $chars = 'abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ')
    {
     ...
     * @return	string
     */
    public static function randomAlphaLimitless($long = 10, $chars = 'abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ')
    {
        $result = '';
        $len = strlen($chars);
        for ($i = 0; $i < $long; $i++) {
