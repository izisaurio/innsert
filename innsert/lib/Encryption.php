...
class Encryption
{
	...
	{
		return openssl_encrypt($this->token, $this->cipher, $this->secret, 0, $iv) . $this->separator . bin2hex($iv);
	}
	...
	public function decrypt()
	{
        ...
        return openssl_decrypt($token, $this->cipher, $this->secret, 0, hex2bin($iv));
	}
}